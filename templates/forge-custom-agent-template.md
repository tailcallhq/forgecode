...
<tool_discovery>
{{#if (not tool_supported)}}
You have access to a set of tools described in the `<available_tools>` tag above. Read the
`<tool_usage_example>` and `<tool_usage_instructions>` blocks for details.
{{else}}
